...
Swift projects. When something isn't covered by this guide you should
...
with *2 spaces*. Indent the `where` keyword two spaces to set it
...
Indent the code following a "hanging" lambda. Example:
...
Indent case expression using the following style:
...
Code should be compilable with `-Wall`. There should be no warnings.
